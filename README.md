This project is the mobile app for the AlmostHere project. It's a transport app using GTFS data. It's only about one company for now, but intended to work with more transports companies/types.
